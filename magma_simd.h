...
static uint32_t pi65_256[256] __attribute__((aligned(32))) = {
...
static uint32_t pi43_256[256] __attribute__((aligned(32))) = {
...
static uint32_t pi21_256[256] __attribute__((aligned(32))) = {
...
void magma_set_key_256(magma_subkeys_256 *subkeys, const uint8_t *key) {
  subkeys->k[0] = _mm256_set1_epi32(GETU32_BE(key));
  subkeys->k[1] = _mm256_set1_epi32(GETU32_BE(key + 4));
  subkeys->k[2] = _mm256_set1_epi32(GETU32_BE(key + 8));
  subkeys->k[3] = _mm256_set1_epi32(GETU32_BE(key + 12));
